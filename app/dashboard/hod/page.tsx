    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Welcome, {user?.name} - Review and approve certificate applications
        </p>
      </div>
        ...
        <Card className="border border-border bg-card">
          <CardContent className="flex items-center gap-4 p-5">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-foreground">{pendingCerts.length}</p>
            </div>
          </CardContent>
        </Card>
        <Card className="border border-border bg-card">
          <CardContent className="flex items-center gap-4 p-5">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-foreground">
                {allCerts.filter((c) => c.hodStatus === "Approved").length}
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <Table>
        <TableHeader>
          <TableRow className="hover:bg-transparent">
            ...
            <TableHead className="text-foreground">HOD Status</TableHead>
        ...
        <TableBody>
          {certificates.map((cert) => (
            ...
            >
              ...
              <TableCell className="text-muted-foreground">{cert.studentRegNo}</TableCell>
              <TableCell className="text-muted-foreground">{cert.department}</TableCell>
              <TableCell className="text-foreground">{cert.certificateType}</TableCell>
